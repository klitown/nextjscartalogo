                ...
                <div className="mx-auto px-4 py-8 sm:px-6 lg:px-8">
                    <div className="flex items-center justify-between sm:justify-between sm:gap-4">
                        <Sheet>
                            ...
                            <SheetContent side="left" className="w-[100vw] lg:w-1/4">
                                <SheetHeader>
                                    <SheetTitle>
                                        Menú principal
                                    </SheetTitle>
                                ...
                                <div className="flex flex-col justify-center items-center gap-3 w-full text-lg text-black mt-5">
                                    ...
                                    hover:bg-indigo-500 hover:text-white hover:rounded-xl">
                                            <HomeIcon height={30} width={30} className="mr-3" />
                                            Inicio
                                        </Link>
                                    </SheetClose>
                                    <SheetClose asChild>
                                        <Link href={`/${params.slug}/dashboard/mitienda`}
                                            className=" cursor-pointer  w-full flex flex-row text-xl font-bold tracking-wide p-2
                                    hover:bg-indigo-500 hover:text-white hover:rounded-xl">
                                            <HeartIcon height={30} width={30} className="mr-3" />
                                            Mi tienda
                                        </Link>
                                    </SheetClose>
                                    <SheetClose asChild>
                                        <Link href={`/${params.slug}/dashboard/misproductos`}
                                            className=" cursor-pointer  w-full flex flex-row text-xl font-bold tracking-wide p-2
                                    hover:bg-indigo-500 hover:text-white hover:rounded-xl">
                                            <ArchiveIcon height={30} width={30} className="mr-3" />
                                            Mis productos
                                        </Link>
                                    </SheetClose>
                                    <div className=" cursor-pointer  w-full flex flex-row text-xl font-bold tracking-wide p-2
                                    hover:bg-indigo-500 hover:text-white hover:rounded-xl">
                                        <RocketIcon height={30} width={30} className="mr-3" />
                                        Facturación
                                    </div>
                                </div>
                            </SheetContent>
