...
function ListadoProductos({ productos }: any) {
    ...
    const handleSearch = (value: string) => {
        ...
        let a = listadoProductos.filter(
            (producto) => producto.nombre.toLowerCase() == value.toLowerCase()
        );
        if (a.length >= 1) {
            console.log(a);
                            ...
                            <div>
                                ...
                                <div className="mt-2 sm:flex sm:items-center sm:gap-2">
                                    ...
                                    {producto.mas_buscado ? (
                                        <span className="bg-green-500 text-white rounded-full px-3 py-2 text-[12px]">
                                            {" "}
                                            Más buscado{" "}
                                        </span>
                                    ) : null}
