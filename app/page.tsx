...
function Home() {
    ...
    return (
        <div className="bg-[url(/grid.svg)]">
            <div className={`flex flex-col justify-start items-center`}>
                ...
                <section className="flex flex-col items-center w-full mt-12">
                    <div className="w-full max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
                        <h1
                            className={`${agrandir.className} text-6xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl font-bold text-black tracking-wide leading-tight`}
                        >
                            Tu propia{" "}
                            <span className="animate-text md:mx-4 bg-gradient-to-r from-orange-500 via-black to-orange-500 bg-clip-text text-transparent bg-300% inline-block">
                                tienda
                            </span>{" "}
                            te está esperando.
                        </h1>
                    ...
                    <div className="grid grid-cols-1 lg:h-screen lg:grid-cols-2">
                        ...
                        <div className="relative flex justify-center items-center bg-gradient-to-br from-orange-500 to-black rounded-xl">
                            <div className="p-8 sm:p-16 lg:p-24 flex justify-center items-center flex-col">
                                ...
                                >
                                    Construí tu marca con nosotros y crecé tu
                                    negocio desde la comodidad de tu hogar.
                                    Nosotros nos encargamos de todo el
                                    mantenimiento para que te enfoques en lo que
            ...
            <div ref={comoFuncionaRef} className="overflow-hidden sm:py-20">
                        ...
                        <div className="lg:pr-8 lg:pt-4 py-4">
                            <div className="lg:max-w-lg">
                                ...
                                <p className="mt-6 text-lg leading-8 text-gray-600">
                                    No pierdas ventas debido a procesos de
                                    compra complicados. Con nosotros, tus
                                    clientes pueden comprar de manera rápida y
                                    sencilla, lo que se traduce en una
                                    experiencia de compra más agradable y
                                    mayores beneficios para tu negocio
                                </p>
                                <dl className="mt-3 max-w-xl space-y-6 p-3 text-base leading-7 text-gray-600 lg:max-w-none">
                                    {features.map((feature) => (
                                        <div
                                            key={feature.name}
                                            className="relative p-5 border border-gray-300 rounded-xl bg-white/40"
                                        >
            ...
            <div
                ...
                className="items-center w-full px-5  mx-auto md:px-12 lg:px-16 max-w-7xl"
            >
                            ...
                            >
                                <li>
                                    ...
                                    <div className="mt-2 text-base text-orange-400">
                                        ...
                                        ecommerce. Queremos conectar clientes
                                        con negocios de manera sencilla, al
                                        alcance de todos.
                                    </div>
                                </li>
                                <li>
                                    ...
                                    <div className="mt-2 text-base text-orange-400">
                                        Sì, los planes tienen un costo mensual
                                        fijo.
                                    </div>
                                </li>
                                <li>
                                    ...
                                    <div className="mt-2 text-base text-orange-400">
                                        No cobramos ninguna comisión por venta.
                                        Solamente cobramos el pago mensual.
                                    </div>
                                </li>
                                <li>
                                    <div>
                                    ...
                                    <div className="mt-2 text-base text-orange-400">
                                        Nosotros nos encargamos de conectar tu
                                        negocio con los clientes. Luego, la
                                        finalización del pedido corre por cuenta
                                        del negocio.
                                    </div>
                                </li>
                                <li>
                                    <div>
                                        <p className="mt-5 text-lg font-medium leading-6 text-white">
                                            ¿Qué métodos de pago puedo ofrecer a
                                            mis clientes?
                                        </p>
                                    </div>
                                    <div className="mt-2 text-base text-orange-400">
                                        Estamos trabajando para integrar una
                                        pasarela de pagos para permitir cobrar a
                                        los clientes mediante transferencias y
                                        tarjetas.
                                    </div>
                                </li>
                                <li>
                                    ...
                                    <div className="mt-2 text-base text-orange-400">
                                        ...
                                        equipo está siempre en línea brindarte
                                        asistencia.
                                    </div>
                                </li>
                            </ul>
            ...
            <section className="bg-black container mx-auto rounded-xl">
                <div className="flex flex-col justify-center flex-1 px-8 py-8 md:px-12 lg:flex-none lg:px-24">
                    <div className="relative px-4 py-10 sm:px-6 lg:px-8">
                        <div className="w-full p-0 mx-auto text-center">
                            ...
                            >
                                Ponete en contacto con nosotros y solicitá una
                                prueba
                            </p>
                            <p className=" mt-4 text-lg tracking-tight text-white/70">
                                Contactanos via whatsapp y solicitá una tienda
                                de prueba, o ante cualquier duda que tengas,
